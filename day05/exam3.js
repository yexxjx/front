...
// 컴퓨터는 2진수, true/false, 세상에 모든 자료를 대체할 수 없다
// 조건 : 총점이 90점이상, 참 : 성공, 거짓 : 실패
let score1=prompt("점수1");
let score2=prompt("점수2");
let total=Number(score1)+Number(score2);
// console.log(`${total>=90? "성공" : "실패" }`);
// if(조건){참}else{거짓}
...
let seatList= ['O', 'X', 'O'];
let indexnum=prompt("인덱스 번호");
if(seatList[indexnum]=="X"){console.log("예약 성공");}
...
let int3=prompt("게임 점수");
if(int3>=900){console.log("A급 경품");}
else if(int3>=700){console.log("B급 경품");}
else if(int3>=500){console.log("C급 경품");}
...
let score=prompt("점수");
if(score<70){console.log("재시험");}
else if(score<80){console.log("C등급");}
else if(score<90){console.log("B등급");}
...
let drink=prompt("원하는 음료 선택. 0콜라 1사이다 2커피");
if(drink>=0 && drink<=2){console.log(`선택하신 음료는 ${drinkNames[drink]}입니다. 가격은 ${drinkPrices[drink]}원 입니다.`);}
